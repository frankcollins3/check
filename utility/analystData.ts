...
// relativity: { current: 404, variance: null, company: 'bofa', ticker: "bac" }
    relativity: { current: 404, variance: null, company: 'Bank of America' }
    // date: "6-1-2024"
}
...
const goldmanSachsEstimate:estimateINTERFACE = {
    ...
    relativity: { current: 404, variance: null, company: 'Goldman Sachs' }
}
...
const morganStanleyEstimate:estimateINTERFACE = {
    ...
    relativity: { current: 404, variance: null, company: 'Morgan Stanley' }
}
...
const jpMorganEstimate:estimateINTERFACE = {
    ...
    relativity: { current: 404, variance: null, company: 'JP Morgan' }
}
