...
import JSON from "utility/alphaVantageAPIstockData/appleStockData"  
...
function RENDER() {
    ...
    const renderLineChart = (
        ...
        <Tooltip />
        <Legend />    
        { CANDLESTICK_CHART_MULTI_SHOW_O === true && <Line className="line" type="monotone" 
         dataKey={CANDLESTICK_CHART_CALENDAR_TODAY_CLICKED ===  true ? "2024-06-07 11:40:00.1.open" : "open"} stroke="goldenrod" 
        /> }
        {/* { CANDLESTICK_CHART_MULTI_SHOW_O === true && <Line className="line" type="monotone" dataKey="1. open" stroke="goldenrod" /> } */}
